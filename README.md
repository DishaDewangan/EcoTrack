...
## 🚀 Live Demo
Check out the [live demo](https://dishadewangan.github.io/EcoTrack/) to try it out in real-time!
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/dishadewangan/EcoTrack.git
   cd EcoTrack
   ```
